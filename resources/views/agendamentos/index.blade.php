...
@section('content')
    ...
    <div class="m-portlet">
        <div class="m-portlet__body">
            <p>Para alterações com menos de 2 dias da data do agendamento, por favor realizar por telefone.</p>
...
<script>
	...
	$('#datatable').DataTable({
		...
		columns: [
			...
			{
				data: 'sugerir_unir_ag',
				render: function ( data, type, row )
				{
					return '<p>'+ row.sugerir_unir_ag +'</p>';
				}
			},
